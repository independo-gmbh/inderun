...
public protocol IndeRunApi: Sendable {
    ...
    func run(request: TaskRequest) async throws -> TaskResult
    ...
    func stream(request: TaskRequest) async throws -> StreamRun
    ...
    func checkCapabilities() async -> [ProviderCapabilitySnapshot]
}
