...
dependencies {
    ...
    testImplementation("androidx.compose.ui:ui-test:1.11.3")
    testImplementation("androidx.compose.ui:ui-test-junit4:1.11.3")
    testImplementation("androidx.compose.ui:ui-test-manifest:1.11.3")
